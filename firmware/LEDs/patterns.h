...
{
        {       
                { 0, 100, 0,   0, 100, 0,    0, 100, 0,     0, 100, 0     }, 20, 250                
        },
        {
                { 0, 10, 0,     0,10, 0,      0,10, 0,       0, 10, 0     }, 20, 100
        }
};
// speaker_glow BLUE
Moment speaker_glow[] =
{
        ...
        {
                { 0, 0, 10,     0, 0,10,      0, 0, 25,       0, 0,25   }, 20, 100
        }
};
// staff_glow RED
Moment staff_glow[] =
{
        {                       
                { 100, 0, 0,   100, 0, 0,    100, 0, 0,     100, 0, 0     }, 20, 250
        },
        {
                { 10, 0, 0,    10, 0, 0,     10, 0, 0,      10, 0, 0      }, 20, 100
        }
};
// End Memebr Moment(s)
