...
// Member glow Moment(s)
// attendee_glow GREEN
Moment attendee_glow[] =
{
        {       
                { 0, 100, 0,   0, 100, 0,    0, 100, 0,     0, 100, 0     }, 15, 250                
        },
        {
                { 0, 10, 0,     0,10, 0,      0,10, 0,       0, 10, 0     }, 15, 100
        }
};
// speaker_glow BLUE
Moment speaker_glow[] =
{
        {                       
                { 0, 0, 100,   0, 0, 100,    0, 0,100,     0, 0,100     }, 15, 250                
        },
        {
                { 0, 0, 10,     0, 0,10,      0, 0, 10,       0, 0,10   }, 15, 100
        }
};
// staff_glow RED
Moment staff_glow[] =
{
        {                       
                { 100, 0, 0,   100, 0, 0,    100, 0, 0,     100, 0, 0     }, 15, 250
        },
        {
